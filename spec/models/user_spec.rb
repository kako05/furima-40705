  ...
  describe 'サインイン' do
    ...
    context 'サインインできないとき' do
      ...
      it "セイが空では登録できない" do
        @user.family_reading = ''
        @user.valid?
        expect(@user.errors.full_messages).to include("Family reading can't be blank", "Family reading is invalid. Input full-width katakana characters.")
      end
      it "メイが空では登録できない" do
        @user.first_reading = ''
        @user.valid?
        expect(@user.errors.full_messages).to include("First reading can't be blank", "First reading is invalid. Input full-width katakana characters.")
      end
